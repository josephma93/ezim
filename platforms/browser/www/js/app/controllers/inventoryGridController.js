            ...
            function inventoryGridCtrl($uibModal, $uibModalInstance, BarcodeScannerSvc, inventoryDatasource) {
                ...
                function _fetchData() {
                    ...
                    inventoryDatasource.query({
                            'l': itemsPerPage,
                            'sk': numResultsToSkip,
                            'q': { 'name': searchCriteria },
                            's': sortExpression
                        })
                        .then(function successCb(inventory) {
                ...
                function _updateRecordCount() {
                    ...
                    if (searchCriteria) {
                        requestParams.q = { 'name': searchCriteria };
                    }

                    inventoryDatasource.count(requestParams)
                        .then(function successCb(count) {
                            that.pagination.totalItems = count;
                        });
                }
                ...
                function deleteMerchandise(merchandise, index) {
                    ...
                    function successCb() {
						that.transactionInProgress = true;
						inventoryDatasource.remove(merchandise.code)
                    ...
                    $uibModal.open({
                        'templateUrl': 'js/app/views/confirmDelete.tpl.html',
                        'size': 'sm'
